    ...
    const QuestionComponent = ({ questionData }: any) => {
        switch (questionData.type) {
            ...
            case "identify-information":
                return (
                    <IdentifyInformation question={questionData} {...methods} />
                );
            case "multiple-choice-more":
                return (
                    <MoreMultipleChoice question={questionData} {...methods} />
                );
            case "multiple-choice-one":
                return (
                    <OneMultipleChoice question={questionData} {...methods} />
                );
            case "sentence-completion":
                return (
                    <SentenceCompletion question={questionData} {...methods} />
                );
