      ...
      <section className="pb-12.5 pt-32.5 lg:pb-25 lg:pt-45 xl:pb-30 xl:pt-50">
        <div className="relative z-1 mx-auto max-w-c-1016 px-7.5 pb-7.5 pt-10 lg:px-15 lg:pt-15 xl:px-20 xl:pt-20">
          ...
          >
            ...
            <div className="mx-auto mb-12.5 flex w-3/6 flex-col items-center justify-center gap-1 rounded-lg border border-stroke dark:border-strokedark p-1 md:flex-row">
              <button
            ...
            <div className="flex flex-col">
              <div className="flex flex-col items-center md:flex-row md:gap-8">
                <button
                  ...
                  className="text-body-color dark:text-body-color-dark dark:shadow-two mb-3 flex w-full items-center justify-center rounded-lg border border-stroke px-6 py-3 text-base outline-none transition-all duration-300 hover:border-primary hover:bg-primary/5 hover:text-primary dark:border-transparent dark:bg-[#2C303B] dark:hover:border-primary dark:hover:bg-primary/5 dark:hover:text-primary dark:hover:shadow-none md:mb-6"
                >
                  <span className="mr-3">
                    <svg
                      width="20"
                ...
                <button
                  ...
                  className="text-body-color dark:text-body-color-dark dark:shadow-two mb-6 flex w-full items-center justify-center rounded-lg border border-stroke px-6 py-3 text-base outline-none transition-all duration-300 hover:border-primary hover:bg-primary/5 hover:text-primary dark:border-transparent dark:bg-[#2C303B] dark:hover:border-primary dark:hover:bg-primary/5 dark:hover:text-primary dark:hover:shadow-none"
                >
                  <span className="mr-3">
                    <svg
                      fill="currentColor"
              ...
              <div>
                ...
                <div>
                  <button
                    ...
                    className={`mx-auto mt-6 flex items-center justify-center rounded-full bg-black px-6 py-3 font-medium text-white duration-300 ease-in-out hover:bg-blackho dark:bg-btndark dark:hover:bg-blackho`}
              ...
              <div className="flex flex-wrap gap-10 md:justify-between xl:gap-15">
                <div className="flex items-center">
                  ...
                  >
                    ...
                    />
                    <span className="group mr-1 mt-1 flex h-5 min-w-[20px] items-center justify-center rounded border-gray-300 bg-gray-100 text-blue-600 peer-checked:bg-primary dark:border-gray-600 dark:bg-gray-700">
                      <svg
