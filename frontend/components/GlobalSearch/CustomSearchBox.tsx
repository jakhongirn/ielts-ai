...
function CustomSearchBox({ refine }) {
  return (
    <form
      action=""
      role="search"
      className="sticky top-0 z-[999] border-b border-stroke dark:border-strokedark dark:bg-black"
    >
      <div className="relative">
        <input
          ...
          className="h-[74px] w-full rounded-lg pl-[60px] pr-5 text-black outline-none dark:bg-black"
        />
        <span className="absolute left-0 top-0 flex h-[74px] w-[52px] items-center justify-center text-waterloo">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
