                ...
                <div className="flex flex-wrap gap-4 xl:justify-between ">
                  <div className="mb-4 flex md:mb-0">
                    <label
                      ...
                      className="flex max-w-[425px] cursor-pointer select-none"
                    >
                      <input
                        id="default-checkbox"
                        type="checkbox"
                      ...
                      />
                      <span className="group mt-2 mr-2 flex h-5 min-w-[20px] items-center justify-center rounded border-gray-300 bg-gray-100 text-blue-600 peer-checked:bg-primary dark:border-gray-600 dark:bg-gray-700">
                        <svg
